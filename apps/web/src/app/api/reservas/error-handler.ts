...
export const handleError = createRouteErrorHandler({
  errorMap: {
    ...
    MENU_NOT_FOUND: "menu.notFound",
    PAGAMENTO_VALOR_INVALIDO: "pagamento.valorInvalido",
    PAGAMENTO_METODO_OBRIGATORIO: "pagamento.metodoObrigatorio",
    CAUCAO_BLOQUEADA: "caucao.bloqueada",
  },
  statusMap: {
    NOT_FOUND: 404,
    MENU_NOT_FOUND: 400,
    PAGAMENTO_VALOR_INVALIDO: 400,
    PAGAMENTO_METODO_OBRIGATORIO: 400,
    CAUCAO_BLOQUEADA: 409,
    SLOT_OCCUPIED: 409,
    DAY_BLOCKED: 409,
