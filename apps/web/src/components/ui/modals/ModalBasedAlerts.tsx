...
const alertConfig = {
  success: {
    ...
    buttonClass: "bg-success-500 hover:bg-success-600",
...
export const ModalBasedAlerts: React.FC<ModalBasedAlertsProps> = ({
  isOpen,
  onClose,
  onConfirm,
  type,
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            {showCancel && (
              <button
                ...
                onClick={onClose}
                disabled={isLoading}
                className="flex justify-center px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors sm:w-auto disabled:opacity-50"
              >
                Cancel
              </button>
            )}
            <button
              ...
              onClick={onConfirm}
              disabled={isLoading}
              className={`flex justify-center px-4 py-3 text-sm font-medium text-white rounded-lg shadow-theme-xs disabled:opacity-50 sm:w-auto ${config.buttonClass}`}
            >
              {isLoading ? t("common.loading", { defaultValue: "Loading..." }) : confirmText}
            </button>
          </div>
        </div>
      </div>
