...
export const lancheService = {
  ...
  async getLanchesDoDia(data?: Date): Promise<LancheDoDia[]> {
    ...
    const lanchesFestas: LancheFesta[] = festas.map((r) => {
      ...
      return {
        ...
        idadeAniversariante,
        menu,
        bolo: r.bolo ?? undefined,
        boloTema: r.boloTema ?? undefined,
        boloQuantidade: r.boloQuantidade ?? undefined,
  ...
  async getLancheByReservaId(reservaId: string): Promise<LancheFesta> {
    ...
    return {
      ...
      idadeAniversariante,
      menu,
      bolo: reserva.bolo ?? undefined,
      boloTema: reserva.boloTema ?? undefined,
